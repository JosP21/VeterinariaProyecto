...
(function(h) {
	...
	n.defaults = {
		...
		oLanguage: {
			...
			sEmptyTable: "<i>No hay datos disponibles en la tabla.</i>",
			...
			sLoadingRecords: "Gargando...",
			sProcessing: "Procesando...",
			sSearch: "<span style='font-size:15px;'>Buscar:</span>",
			sSearchPlaceholder: "",
			sUrl: "",
