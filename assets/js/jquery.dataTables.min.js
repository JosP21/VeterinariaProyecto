...
! function(a) {
	...
	Xa("cells()", function(b, c, e) {
			...
			oLanguage: {
				...
				sInfoEmpty: "Mostar 0 a 0 de 0 registros",
				sInfoFiltered: "(Filtrado de _MAX_registros totales)",
				sInfoPostFix: "",
				sDecimal: "",
				sThousands: ",",
				sLengthMenu: "Ver _MENU_ registros",
				sLoadingRecords: "Cargando...",
				sProcessing: "Procesand...",
				sSearch: "Buscar:",
				sSearchPlaceholder: "",
				sUrl: "",
				sZeroRecords: "<h1 style='font-size: 16px;'>No hay Registro</h1>"
			},
