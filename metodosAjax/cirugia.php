        ...
        <div class="container-fluid">
            ...
            <form id="frmCirugia" name="frmCirugia" method="post" action="../metodosAjax/terminarCirugias.php">
                ...
                <div class="group-material">
                 <input autofocus autocomplete="off" type="text" name="nombreexp" id="nombreexp" class="material-control tooltips-general" placeholder="Seleccione.." required="" data-min-length="1" data-selection-required="true" data-toggle="tooltip" data-placement="top" title="" onkeypress="return sololetras(event);" list="listaExp" data-original-title="Solo letras">
