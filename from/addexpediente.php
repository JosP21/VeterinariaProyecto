                    ...
                    <div class="container-fluid">
                       <div class="col-xs-12 col-sm-offset-0">
                            ...
                            <div style="margin-left: 8%;" class="col-sm-6 col-sm-offset-0">
                                <div class="group-material" id="propietarioG">
                                    <div id="autocompletar">
                                        ...
                                        <input type="text" name="nombrepropietario" id="nombrepropietario" class="material-control tooltips-general" placeholder="Nombre..." required="" data-min-length="1" data-selection-required="true" data-toggle="tooltip" data-placement="top" title="" onkeypress="return sololetras(event);" list="listaExpm" data-original-title="Solo letras" autocomplete="off">
                                        <datalist id="listaExpm">
                                            <?php
                        ...
                        <div class="modal-footer">
                            <center>
                                <button data-dismiss="modal" type="button" onclick="GuardarExpediente()" class="btn btn-primary"><i class="zmdi zmdi-floppy"></i> &nbsp;&nbsp; Guardar</button>
                            </center>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="container-fluid">
                                   <div class="col-xs-12 col-sm-offset-0">
                                    ...
                                    <div class="modal-footer">
                                        <center>
                                            <button data-dismiss="modal" type="button" class="btn btn-primary" onclick="GuardarProp();"><i class="zmdi zmdi-floppy"></i> &nbsp;&nbsp; Guardar</button>
                                        </center>
                                    </div>
                                </div>
                            </div>
                       ...
                       $.ajax({
                        ...
                        success:function(resp){
                          if(resp=="ERROR"){
                            ...
                            location.href="../from/servicios.php";
                        }
                    }
                });
                       return false;
