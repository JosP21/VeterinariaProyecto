                      ...
                      <div class="row">
                          <section class="full-reset text-center" style="padding: 40px 0;">
                            ...
                            <div class="tile-icon full-reset"><i class="zmdi zmdi-cloud-download" style="color: #5aa6a1;"></i></div>
                                <div class="tile-num full-reset" style="font-size: 25px;background-color: #41a6a4;color: #fff;">Restauración</div>
                            </article>
                            <article class="tile" data-toggle="modal" data-target= "#citas">
                                ...
                                <div class="tile-num full-reset" style="font-size: 25px;background-color: #41a6a4;color: #fff;">Backup</div>
                            </article>
                        </section>
                      </div>
