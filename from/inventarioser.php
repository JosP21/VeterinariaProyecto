...
<head>
    ...
    <script type="text/javascript">
        ...
        function editar(id){
                  $.ajax({
                    type:"POST",
                    url:"../metodosAjax/inventarioServ.php",
                    data:{val:id},
                    ...
                    if(result.value){
                        $.ajax({
                            ...
                            success:function(resp){
                                ...
                                //$("#miTabla").html(resp);
                                mostrarMensaje('Eliminado','success',null,"El servicio se elimino satisfactoriamente",true);
                            }
                        });
                    }
                })
                          ...
                          $result=$conexion->query("SELECT productos.nombre as producto,
                            ...
                            if($result){
                                ...
                                <td>
                                    ...
                                    <a href="#"  data-toggle= "modal" data-target= "#modificarservicio" class="material-control" required="" maxlength="50" data-toggle="tooltip" data-placement="top" title="Editar"  onclick="editar(<?php echo $fila->id?>)">
         ...
         <!--Modal para Inventario-->
            <div class="modal fade" id="modificarservicio">
                <div class="modal-dialog">
                    <div class="modal-content" style="width: 70%;margin-left: 25%;">
                       ...
                       <div class="modal-footer">
                            <center>
                              <button type="submit" class="btn btn-success" data-dismiss="modal" onclick="modifcarProd()"><i class="zmdi zmdi-floppy"></i> &nbsp;&nbsp; Modificar</button>
